...
expected_origin="ssh://git@127.0.0.1:2224/root/jankurai-core.git"
repo_root="${CI_ROOT}"
...
shadow_cfg="${repo_root}/.jeryu/local/repos/jankurai-core.toml"
shadow_command="jeryu repo shadow --repo root/jankurai-core"
...
if ! jeryu repo shadow --repo root/jankurai-core; then
