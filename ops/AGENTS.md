...
- Do not create git worktrees. Use the existing primary checkout; existing worktrees may only be audited, preserved, or safely retired under the family cleanup protocol.
