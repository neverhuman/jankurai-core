...
// CopyCodeReport type tree moved to jankurai-audit-kernel (W5 split). The
// scanner functions below stay in core; the types are re-exported here so
// every `crate::audit::copy_code::*` path resolves unchanged.
